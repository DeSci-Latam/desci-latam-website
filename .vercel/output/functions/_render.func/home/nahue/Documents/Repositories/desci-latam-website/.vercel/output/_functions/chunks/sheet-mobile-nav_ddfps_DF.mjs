import { s as createAstro, t as createComponent, u as renderTemplate, v as maybeRenderHead, w as addAttribute, C as renderComponent, E as renderSlot } from './astro/server_Dluq3R61.mjs';
import { a as cn, e as footerLinks, s as siteConfig, $ as $$Icon, T as ThemeToggle, B as Button } from './base-layout_CTLW2O-Y.mjs';
...
const $$Astro$1 = createAstro("https://desci-latam-website-git-header-descilatam.vercel.app");
...
}, "/home/nahue/Documents/Repositories/desci-latam-website/src/components/layout/footer.astro", void 0);
...
}, "/home/nahue/Documents/Repositories/desci-latam-website/src/components/layout/header.astro", void 0);
  ...
  pagesNav: [
    {
      ...
      items: [
        ...
        },
        {
          title: "Waitlist",
          href: "/waitlist",
          description: "A waitlist form using Astro DB, React Hook Form & Sonner. Static page.",
        ...
        },
        {
          title: "Newsletter",
          href: "/newsletter",
          description: "A newsletter form using Astro DB & Simple Stack Form. Counter display!",
...
function MainNavigationMenu() {
  return /* @__PURE__ */ jsx(NavigationMenu, { children: /* @__PURE__ */ jsxs(NavigationMenuList, { children: [
    /* @__PURE__ */ jsxs(NavigationMenuItem, { children: [
      /* @__PURE__ */ jsx(NavigationMenuTrigger, { children: pages.title }),
      /* @__PURE__ */ jsx(NavigationMenuContent, { children: /* @__PURE__ */ jsx("ul", { className: "grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ", children: pages.items?.map((page) => /* @__PURE__ */ jsx(ListItem, { ...page }, page.title)) }) })
    ] }),
    /* @__PURE__ */ jsxs(NavigationMenuItem, { children: [
...
const SheetPortal = ({
  className,
  ...props
}) => /* @__PURE__ */ jsx(SheetPrimitive.Portal, { ...props, children: /* @__PURE__ */ jsx("div", { className: cn(className), children: props.children }) });
